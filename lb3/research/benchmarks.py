...
plt.plot(delta, ans, 'o-', linewidth=2, markersize=8, color='blue', label='Практические данные')

# plt.plot(eps, theor, 'g--', linewidth=2, label='Теоретическая')

plt.xlabel('Точность исходных данных', fontsize=14, fontweight='bold')
plt.ylabel('Модуль результата вычислений', fontsize=14, fontweight='bold')
plt.legend(loc='upper left', fontsize=12)

plt.grid(True, which='both', alpha=0.6, linestyle='--')

plt.tight_layout()
plt.savefig('./cnt_it.png')